  ...
  ##'##'## .##',##.
   ## ## ## # ##",#.
    ## ## ## ## ##'
     ## ## ## :##
      ## ## ##."
VOLUME=/Volumes/EXT_SSD
git clone --depth=1 https://github.com/Homebrew/brew $VOLUME/.brew
...
# Add brew to path
export PATH=\$VOLUME/.brew/bin:\$PATH
...
if df -T autofs,nfs \$VOLUME 1>/dev/null
then
